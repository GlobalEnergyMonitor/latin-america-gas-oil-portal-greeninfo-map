...
L.backButton = L.Control.extend({
    ...
    initialize: function(options) {
        ...
        // config, passed in on construction
        // this works! even though CONFIG.go_back is not defined until later, passing this object by reference means the update is available when we need it
	...
	onAdd: function (map) {
	  ...
	  button.innerHTML = '<span class="glyphicon glyphicon-chevron-left"></span><span id="go-back-text">' + this.config.go_back  + '</span>';
